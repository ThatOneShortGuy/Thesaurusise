...
EXCEPTION_WORDS = ['i', 'a', 'an', 'the', 'and', 'is', 'or', 'but', 'if', 'then', 'else', 'when', 'at', 'from', 'by', 'on', 'off', 'for', 'in', 'out', 'over', 'to', 'into', 'with', 'you']
...
if __name__ == '__main__':
    sys.argv.extend("You'll have to tell me how annoying this is".split())
    if len(sys.argv) < 2:
